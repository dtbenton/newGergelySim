...
setwd("C:/Users/bentod2/Documents/projects/current/NEWgergliuSims/cognition/data/sim4a")
setwd("C:/Users/detbe/Documents/projects/NEWgergliuSims/cognition/data/sim4a")
setwd("C:/Users/Deon T. Benton/Documents/projects/NEWgergliuSims/cognition/data/sim4a")
...
D$trialType = rep(c("Incongruent", "Congruent"), each = 1, times = 600)
...
condition_barplot + stat_summary(fun = mean, geom = "bar", position = "dodge") + # add the bars, which represent the means and the place them side-by-side with 'dodge'
  ...
  labs(caption = "Inferring Goals Scenario") +
