...
setwd("C:/Users/detbe/Documents/projects/newGergelySim/psychologicalReview/data/ALIAS/sim2a")

files = list.files(
  pattern = "^Study_sim2a_.*_(control|hab)_tEpochs_[0-9]+(\\.[A-Za-z0-9]+)?$"
)
...
###############################################
##                                           ##
## SIMULATION 2 ANALYSIS: ALIAS no salience ##
##                                           ##
###############################################
###############################################
...
# set working directory
setwd("C:/Users/detbe/Documents/projects/newGergelySim/psychologicalReview/data/ALIASnoSalience/sim2c")

files = list.files(
  pattern = "^Study_sim2c_.*_(control|hab)_tEpochs_[0-9]+(\\.[A-Za-z0-9]+)?$"
)
