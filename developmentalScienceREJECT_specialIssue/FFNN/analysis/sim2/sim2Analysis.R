...
setwd("C:/Users/bentod2/Documents/projects/current/NEWgergliuSims/FFNN/equalLinearCurvedRatio/data/sim2")
#setwd("C:/Users/detbe/Documents/projects/NEWgergliuSims/FFNN/unequalLinearCurvedRatio/data/sim2")
# load the data
exp = read.table(file.choose(), header = FALSE, stringsAsFactors = FALSE)
cntrl = read.table(file.choose(), header = FALSE, stringsAsFactors = FALSE)
